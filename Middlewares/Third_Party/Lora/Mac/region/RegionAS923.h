 ...
 */
#define AS923_RX_WND_2_FREQ                         923200000+ANT_SHIFT
 ...
 */
#define AS923_LC1                                   { 923200000+ANT_SHIFT, 0, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }

/*!
 * LoRaMac default channel 2
 * Channel = { Frequency [Hz], RX1 Frequency [Hz], { ( ( DrMax << 4 ) | DrMin ) }, Band }
 */
#define AS923_LC2                                   { 923400000+ANT_SHIFT, 0, { ( ( DR_5 << 4 ) | DR_0 ) }, 0 }
