 ...
 */
#define CN470_RX_WND_2_FREQ                         505300000+FREQ_SHIFT
 ...
 */
#define CN470_FIRST_RX1_CHANNEL                     ( (uint32_t) 500300000+FREQ_SHIFT )

/*!
 * Defines the last channel for RX window 1 for CN470 band
 */
#define CN470_LAST_RX1_CHANNEL                      ( (uint32_t) 509700000+FREQ_SHIFT )
